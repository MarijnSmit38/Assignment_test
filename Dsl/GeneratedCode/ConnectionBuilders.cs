...
namespace Company.Assignment_test
{
	...
	/// </summary>
	public static partial class Systematic_impact_levelReferencesTargetsBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::Company.Assignment_test.Systematic_impact_level)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Company.Assignment_test.Systematic_impact_level)
				{
					if (candidateTarget is global::Company.Assignment_test.Systematic_impact_level)
					{
						global::Company.Assignment_test.Systematic_impact_level sourceSystematic_impact_level = (global::Company.Assignment_test.Systematic_impact_level)candidateSource;
						global::Company.Assignment_test.Systematic_impact_level targetSystematic_impact_level = (global::Company.Assignment_test.Systematic_impact_level)candidateTarget;
						if(targetSystematic_impact_level == null || sourceSystematic_impact_level == null || global::Company.Assignment_test.Systematic_impact_levelReferencesTargets.GetLinks(sourceSystematic_impact_level, targetSystematic_impact_level).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::Company.Assignment_test.Systematic_impact_level)
				{
					if (target is global::Company.Assignment_test.Systematic_impact_level)
					{
						global::Company.Assignment_test.Systematic_impact_level sourceAccepted = (global::Company.Assignment_test.Systematic_impact_level)source;
						global::Company.Assignment_test.Systematic_impact_level targetAccepted = (global::Company.Assignment_test.Systematic_impact_level)target;
						DslModeling::ElementLink result = new global::Company.Assignment_test.Systematic_impact_levelReferencesTargets(sourceAccepted, targetAccepted);
	...
	public static partial class ConcernReferencesTargetConcernBuilder
	{
		...
		{
			if (candidate == null) return false;
			else if (candidate is global::Company.Assignment_test.Concern)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Company.Assignment_test.Concern)
				{
					if (candidateTarget is global::Company.Assignment_test.Concern)
					{
						global::Company.Assignment_test.Concern sourceConcern = (global::Company.Assignment_test.Concern)candidateSource;
						global::Company.Assignment_test.Concern targetConcern = (global::Company.Assignment_test.Concern)candidateTarget;
						if(targetConcern == null || sourceConcern == null || global::Company.Assignment_test.ConcernReferencesTargetConcern.GetLinks(sourceConcern, targetConcern).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::Company.Assignment_test.Concern)
				{
					if (target is global::Company.Assignment_test.Concern)
					{
						global::Company.Assignment_test.Concern sourceAccepted = (global::Company.Assignment_test.Concern)source;
						global::Company.Assignment_test.Concern targetAccepted = (global::Company.Assignment_test.Concern)target;
						DslModeling::ElementLink result = new global::Company.Assignment_test.ConcernReferencesTargetConcern(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
						}
	...
	internal partial class ExampleRelationshipConnectAction : DslDiagrams::ConnectAction
	{
		...
		private partial class ExampleRelationshipConnectionTypeBase : DslDiagrams::ConnectionType
		{
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder Systematic_impact_levelReferencesTargetsBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				...
				{				
					if(targetShapeElement == null)
					{
						return Systematic_impact_levelReferencesTargetsBuilder.CanAcceptSource(sourceElement);
					}
					else
					{				
						return Systematic_impact_levelReferencesTargetsBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				if(targetElement == null) targetElement = targetShapeElement;
				Systematic_impact_levelReferencesTargetsBuilder.Connect(sourceElement, targetElement);
			}
		}
