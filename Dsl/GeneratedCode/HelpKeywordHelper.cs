...
namespace Company.Assignment_test
{
	...
	/// </remarks>
	public partial class Assignment_testHelpKeywordHelper : Assignment_testHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new Assignment_testHelpKeywordHelper.
		/// </summary>
		protected Assignment_testHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the Assignment_testHelpKeywordHelper.
		/// </summary>
		public static Assignment_testHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class Assignment_testHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new Assignment_testHelpKeywordHelperBase.
		/// </summary>
		protected Assignment_testHelpKeywordHelperBase()
			: base() { }
