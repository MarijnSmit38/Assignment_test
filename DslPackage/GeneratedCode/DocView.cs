...
namespace Company.Assignment_test
{
	...
	/// </summary>
	internal partial class Assignment_testDocView : Assignment_testDocViewBase
	{
		/// <summary>
		/// Constructs a new Assignment_testDocView.
		/// </summary>
		public Assignment_testDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class Assignment_testDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new Assignment_testDocView.
		/// </summary>
		protected Assignment_testDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			Assignment_testDocDataBase docData = this.DocData as Assignment_testDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for Assignment_testDocViewBase should be an Assignment_testDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.Assignment_test.Assignment_testDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.Assignment_test.Assignment_testDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.Assignment_test.Assignment_testToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.Assignment_test.Assignment_testToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.Assignment_testDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.Assignment_test.Assignment_testHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.Assignment_test.Assignment_testHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.Assignment_test.Assignment_testHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
